    ...
    (function($) {
        ...
        function countProject($this){
            ...
            if(current > $this.data('count')){
				...
				setTimeout(function(){countProject($this)}, 50);
			}
        }
		function countClients($this){
            var current = parseInt($this.html(), 10);
            ...
            if(current > $this.data('count')){
				...
				setTimeout(function(){countClients($this)}, 50);
			}
        }
		function countCoffee($this){
            var current = parseInt($this.html(), 10);
			
            current = current + 4; /* Where 50 is increment */
            $this.html(current);
            if(current > $this.data('count')){
                $this.html($this.data('count'));
				...
				setTimeout(function(){countCoffee($this)}, 50);
			}
        }
		function countWorks($this){
            var current = parseInt($this.html(), 10);
            ...
            } else if(current==1048){
            
            } else{
				setTimeout(function(){countWorks($this)}, 50);
			}
        }
        $("#project_completed").each(function() {
            $(this).data('count', parseInt($(this).html(), 10));
            $(this).html('0');
            countProject($(this));
						
        });
		$("#happy_clients").each(function() {
            $(this).data('count', parseInt($(this).html(), 10));
            $(this).html('0');
            countClients($(this));
						
        });
		$("#cups_coffee").each(function() {
            $(this).data('count', parseInt($(this).html(), 10));
            $(this).html('0');
            countCoffee($(this));
						
        });
		$("#hours_work").each(function() {
            $(this).data('count', parseInt($(this).html(), 10));
            $(this).html('0');
            countWorks($(this));
